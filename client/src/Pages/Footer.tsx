    ...
    <div className='w-full h-auto bg-fourth'>
      <div className="container lg:max-w-[98%] md:max-w-[98%] max-w-full mx-auto lg:px-0 md:px-0 px-3">
        <div className="py-4 lg:flex block md:flex lg:justify-between md:justify-between justify-center">
          ...
          <div className=" lg:w-[50%] md:w-[50%] w-full lg:flex md:flex flex justify-center flex-wrap lg:gap-9 md:gap-6 gap-11 lg:pt-0 md:pt-0 pt-8">
            <img className="lg:w-[10%] md:w-[10%] max-w-[15%]" src={foot1} alt=""/>
            <img className="lg:w-[10%] md:w-[10%] max-w-[15%]" src={foot2} alt="" />
            <img className="lg:w-[10%] md:w-[10%] max-w-[15%]" src={foot3} alt="" />
            <img className="lg:w-[10%] md:w-[10%] max-w-[15%]" src={foot4} alt="" />
            <img className="lg:w-[10%] md:w-[10%] max-w-[15%]" src={foot5} alt="" />
            <img className="lg:w-[10%] md:w-[10%] max-w-[15%]" src={foot6} alt="" />
          </div>
        </div>
    </div>
  </div>
